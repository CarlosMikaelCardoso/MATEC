...
PUSHBULLET_API_KEY2 = "o.lbovkynEFTscuGNVxbmEFxSrwqfGYtTK"
...
def send_push_notification2(title, body):
    url = "https://api.pushbullet.com/v2/pushes"
    headers = {
        "Access-Token": PUSHBULLET_API_KEY2,
        "Content-Type": "application/json"
    }
    data = {
        "type": "note",
    ...
    if data:
        ...
        if "temperature" in data:
            ...
            if temperature >= 30 and not temperature_alert_sent:
                ...
                send_push_notification2("Alerta de Temperatura", f"Temperatura chegou a {temperature}°C!, Acionando Ventilador")
                ...
                send_push_notification2("Alerta de Temperatura", f"Temperatura diminuída para {temperature}°C!, Ventilador Desligado")
        ...
        if "power" in data and data["power"] == "off":
            ...
            if not power_alert_sent:
                ...
                send_push_notification2("Alerta de Queda de Energia", "A energia caiu!")
        ...
        if "sound" in data and data["sound"] == "detected":
            ...
            if not sound_alert_sent:
                ...
                send_push_notification2("Alerta de Som", "Um som foi detectado!")
